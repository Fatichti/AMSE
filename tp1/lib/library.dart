...
import 'package:tp1/liste_contenu_media.dart';

// On créer le model de la carte type
class CardTypeMedia {
  ...
  CardTypeMedia({required this.titre, required this.sousTitre, required this.imageURL, required this.icone, required this.liste});
...
final cardFilms = [
  CardTypeMedia(
  titre: "RUBRIQUES : FILMS", 
  sousTitre: "Consulter des informations concernant quelques films", 
  imageURL: "assets/cards/cardFilms.gif", 
  icone: "Icons.video_camera_back",
  liste: films,
  ),
  CardTypeMedia(
  titre: "RUBRIQUES : SERIES", 
  sousTitre: "Consulter des informations concernant des séries", 
  imageURL: "assets/cards/cardSeries.jpg", 
  icone: "Icons.movie_creation",
  liste: series,
  ),
  CardTypeMedia(
  titre: "RUBRIQUES : BANDES DESSINEES", 
  sousTitre: "Consulter des informations concernant des bandes dessinées", 
  imageURL: "assets/cards/cardBds.jpg", 
  icone: "Icons.menu_book",
  liste: bds,
  )
];
/*
final cardSeries = CardTypeMedia(
  titre: "RUBRIQUES : SERIES", 
  sousTitre: "Consulter des informations concernant des séries", 
  imageURL: "assets/cards/cardSeries.jpg", 
  icone: "Icons.movie_creation",
...
final bds = [
  ...
  MediaModel(
    ...
    title: "Astérix",
    description: "Astérix, anciennement Astérix le Gaulois, est une série de bande dessinée française créée le 29 octobre 1959 par le scénariste français René Goscinny et le dessinateur français Albert Uderzo\nAprès la mort de René Goscinny en 1977, Albert Uderzo poursuit seul la série, puis passe la main en 2013 à Jean-Yves Ferri et Didier Conrad.\nLa série compte 39 tomes en octobre 2021.",
  ),
];